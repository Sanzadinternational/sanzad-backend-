...
export const GetAllBooking = async(req:Request,res:Response,next:NextFunction)=>{
  try{
        const result= await db.select({
            booking_no:BookingTable.booking_no, 
            pickup:BookingTable.pickup,
            dropoff:BookingTable.dropoff,
            passenger:BookingTable.passenger,
            date:BookingTable.date,
            time:BookingTable.time,
            return_date:BookingTable.return_date,
            return_time:BookingTable.return_time,
            estimated_trip_time:BookingTable.estimated_trip_time,
            distance:BookingTable.distance,
            currency:BookingTable.currency,
            vehicle_name:BookingTable.vehicle_name,
            passengers_no:BookingTable.passengers_no,
            medium_bags:BookingTable.medium_bags,
            passenger_name:BookingTable.passenger_name,
            passenger_email:BookingTable.passenger_email,
            passenger_contact_no:BookingTable.passenger_contact_no,
            ...
            agent_id:PaymentsTable.agent_id,
            vehicle_id:PaymentsTable.vehicle_id,
            suplier_id:PaymentsTable.suplier_id,
            pickup_location:PaymentsTable.pickup_location,
            drop_location:PaymentsTable.drop_location,
            pickup_lat:PaymentsTable.pickup_lat,
            pickup_lng:PaymentsTable.pickup_lng,
            drop_lat:PaymentsTable.drop_lat,
            drop_lng:PaymentsTable.drop_lng,
            distance_miles:PaymentsTable.distance_miles,
            price:PaymentsTable.price,
            reference_number:PaymentsTable.reference_number,
            // passenger_email:PaymentsTable.passenger_email, 
            // passenger_name:PaymentsTable.passenger_name, 
            passenger_phone:PaymentsTable.passenger_phone, 
            // currency:PaymentsTable.currency,
            pickupDetails:PaymentsTable.pickupDetails,
            dropoffDetails:PaymentsTable.dropoffDetails,
            Owner:registerTable.Owner,
            Company_name:AgentTable.Company_name,
        })
        .from(BookingTable)
